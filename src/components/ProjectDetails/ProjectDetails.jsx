            ...
            <Col lg={6} md={6} sm={12} className='mt-5'>
              <div className='project-details'>
                ...
                <p className='cardSubTitle text-justify'>
                  <FontAwesomeIcon className='iconBullent' icon={faCheckSquare} /> Requirment Gathering{' '}
                </p>
                ...
                <p className='cardSubTitle text-justify'>
                  <FontAwesomeIcon className='iconBullent' icon={faCheckSquare} /> Ligula cur maecenas Ligula cur
                  maecenas
                </p>

                <p className='cardSubTitle text-justify'>
                  <FontAwesomeIcon className='iconBullent' icon={faCheckSquare} /> Ligula cur maecenasLigula cur
                  maecenasLigula{' '}
                </p>

                <p className='cardSubTitle text-justify'>
                  <FontAwesomeIcon className='iconBullent' icon={faCheckSquare} /> Ligula cur maecenasLigula cur
                  maecenasLigula cur maecenas{' '}
                </p>
